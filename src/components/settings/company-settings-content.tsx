  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Building2 className="size-6 text-emerald-600" aria-hidden="true" />
        <div>
      ...
      <form onSubmit={(e) => void handleSubmit(e)} className="space-y-6">
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-base font-semibold text-slate-800">Dados da empresa</h2>
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block sm:col-span-2">
              <span className="mb-1 block text-xs font-medium text-slate-600">Razão Social</span>
              <input
                type="text"
            ...
            <label className="block">
              <span className="mb-1 block text-xs font-medium text-slate-600">CNPJ</span>
              <input
                type="text"
                inputMode="numeric"
                value={form.cnpj}
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <label className="block">
              <span className="mb-1 block text-xs font-medium text-slate-600">Estado (UF)</span>
              <input
                type="text"
                maxLength={2}
                value={form.state}
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-base font-semibold text-slate-800">Fiscal (NF-e)</h2>
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block">
              <span className="mb-1 block text-xs font-medium text-slate-600">Série NF-e</span>
              <input
                type="text"
                inputMode="numeric"
                value={form.nfeSerie}
            ...
            <label className="block">
              ...
              <input
                ...
                className="h-10 w-full rounded-lg border border-slate-100 bg-slate-50 px-3 text-sm text-slate-400 outline-none"
              />
            </label>
          </div>
        </section>
